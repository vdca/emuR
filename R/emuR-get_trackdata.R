...
##' @param nrOfClusters number of clusters created (see \code{parallel::makeCluster}) when processing the \code{seglist} entries.
...
"get_trackdata" <- function(emuDBhandle, seglist = NULL, ssffTrackName = NULL, cut = NULL, 
  ...
  data_list = get_td_lapply(cl = cl, # used to be 
                            1:nrow(seglist), 
                            function(i){
