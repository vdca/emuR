...
test_that("Load example database ae",{  
  ...
  test_that("Query labels",{
    # sequence as seglist
    sl1=query(ae,
              query = "[Text == more -> Text == customers]",
              resultType = 'emusegs')
  ...
  test_that("Query combined sequence dominance",{
    ...
    r1 = query(ae, 
               query = "[[Syllable == W -> Syllable == W] ^ [Phoneme == @ -> Phoneme == s]]",
               resultType = NULL)
  ...
  test_that("Query using Start function",{
    ...
    r5 = query(ae,"Phoneme == p & Start(Word, Phoneme) = 0",
               bundlePattern = '.*7',
               resultType = NULL)
  ...
  test_that("Query using and operator",{
    sl1 = query(ae, 'Text == them & Accent == W',
                resultType = 'emusegs')
  ...
  test_that("timeRefSegmentLevel works correctly",{
    ...
    expect_error(query(ae, "[Syllable == W]", timeRefSegmentLevel = "badLevelName"), 
